...
import { PNotice } from "../components/ui/PNotice";
    ...
    <div className="space-y-20 pb-20">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-2 mb-10">
          ...
          <h2 className="text-2xl sm:text-4xl font-serif text-[#181516]">
            Shop By Category
          </h2>
        </div>
          ...
          {featuredCategories.map((cat) => (
            ...
            >
              ...
              <div className="absolute bottom-6 inset-x-6 text-[#FAF9F7] space-y-1 transform group-hover:-translate-y-1 transition-transform">
                <span className="text-[10px] uppercase tracking-widest text-[#F6E0E3]">
                  Collection
                </span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4 border-t border-[#E9E2E3]">
                {homeData.values.map((v, idx) => (
                  <div key={idx} className="space-y-1">
                    <h4 className="text-xs font-semibold text-[#181516] uppercase tracking-wider">
                      {v.title}
                    </h4>
                    <p className="text-[11px] text-[#807779] leading-normal">
                      {v.description}
                    </p>
                  </div>
                ))}
